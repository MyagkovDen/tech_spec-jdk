...
public class Map extends JPanel {
     ...
     *
     * @param mode режим боя (игрок против игрока, компьютер против игрока)
     * @param fSzX fieldSizeX (размер поля)
     * @param fSzY fieldSizeY (размер поля)
     * @param wLen выигрышная длина (число крестиков/ноликов, расположенных в ряд, необходимых для победы)
     * */
